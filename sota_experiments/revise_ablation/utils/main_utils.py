...
def load_checkpoint_2(model):

    #checkpoint_path = os.path.join(config['model_saving_path'], config['run_id'], 'checkpoint.pth')
    c_p = '/workspace/work/misc/O2ONet/sota_experiments/revise_ablation/saved_model/51cnh4s6/best_model.pth'
...
def load_checkpoint(config, model, optimizer):
    ...
    #checkpoint_path = os.path.join(config['model_saving_path'], config['run_id'], 'checkpoint.pth')
    checkpoint_path = '/workspace/work/misc/O2ONet/sota_experiments/revise_ablation/saved_model/19vom5j4/best_model.pth'
