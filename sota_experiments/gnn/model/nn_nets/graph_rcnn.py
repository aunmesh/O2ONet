...
class graph_rcnn(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        self.object_node_embedder = self.make_linear_layer([4206, 512])
        self.relationship_node_embedder = self.make_linear_layer([77, 512])
    ...
    def forward(self, data_item):
        ...
        rel_node_feats = torch.zeros(total_num_rels, 77, device=self.config['device'])
        ...
        for b in range(batch_size):
            ...
            rel_node_feats[lower:lower+temp_num_rels, :] = data_item['relative_spatial_feature'][b, temp_indices_start, temp_indices_end]
