...
class hgat(torch.nn.Module):
    ...
    def forward(self, data_item):
        ...
        triplet_features = torch.zeros((batch_size,250,77), device=self.config['device'])
        ...
        for b in range(batch_size):
            ...
            temp_features = data_item['relative_feature'][b, :, temp_indices_0, temp_indices_1, :]
            temp_features = temp_features.permute(1,0,2)
            temp_features = temp_features.flatten(1)
