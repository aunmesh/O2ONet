...
class graph_rcnn(torch.nn.Module):
    ...
    def make_classifier_inputs_graph_rcnn(self, obj_feature, edge_feature, node_embeddings, 
        ...
        for b in range(num_batches):
            ...
            for i in range(num_pairs):
                ...
                emb0, emb1 = obj_feature[b, ind0], obj_feature[b, ind1]
                ...
                emb0, emb1 = edge_feature[b, ind0, ind1], edge_feature[b, ind1, ind0]
                
                temp_emb0 = aggregate(emb0, emb1, 'mean')
                temp_emb = aggregate(temp_emb0, embed2, 'mean')
    ...
    def forward(self, data_item):
        ...
        obj_feature = self.node_feature_resize(data_item['concatenated_node_features'])
        edge_feature = self.edge_feature_resize(data_item['interaction_feature'])
