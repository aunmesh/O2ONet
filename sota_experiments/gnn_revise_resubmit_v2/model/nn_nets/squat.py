...
class SQUAT(torch.nn.Module):
    ...
    def make_classifier_inputs(self, edge_embeddings, pairs, num_rels):
        ...
        feat_dim = edge_embeddings.shape[-1]
    ...
    def forward(self, data_item):
        ...
        classifier_input, num_pairs = self.make_classifier_inputs(edge_embeddings, 
